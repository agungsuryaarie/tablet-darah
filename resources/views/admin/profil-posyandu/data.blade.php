                    ...
                    <div class="col-md-4">
                        <div class="card card-widget widget-user">
                            <div class="widget-user-header bg-info">
                                ...
                                <h5 class="widget-user-desc">{{ Auth::user()->posyandu->posyandu }}</h5>
                            </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="card">
                        <form method="POST" action="{{ route('profilposyandu.update', $user->id) }}">
                            @csrf
                            @method('put')
    ...
    <div class="modal fade" id="modal-lg-ps{{ $user->id }}">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="card">
                        <form method="POST" action="{{ route('profilposyandu.update.password', $user->id) }}">
                            @csrf
                            @method('put')
                            <input type="hidden" name="id" value="{{ $user->id }}">
                            <div class="card-body">
    ...
    <div class="modal fade" id="modal-lg-f{{ $user->id }}">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="card">
                        <form method="POST" action="{{ route('profilposyandu.update.foto', $user->id) }}"
